...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/tmpDataSource" pool-name="tmpDataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/tmpDatabase;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="tmpSecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/tmpDataSource"/>
